...
SECRET_KEY = '&mznwxbmmn2wis*_sjlhq5@uf7)v-q6_b^0(ddxc-=zf56sr&1'
...
SOCIAL_AUTH_FACEBOOK_SECRET = 'XXXXX' # Facebook App Secret

SOCIAL_AUTH_TWITTER_KEY = 'XXX' # Twitter API Key
SOCIAL_AUTH_TWITTER_SECRET = 'XXX' # Twitter API Secret

SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = 'xx' # Google Consumer Key
...
EMAIL_HOST_USER = 'email00@gmail.com' 
